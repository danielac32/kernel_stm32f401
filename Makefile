...
blink:
	...
	arm-none-eabi-ld app/blink/entry.o app/blink/main.o app/blink/syscall.o app/blink/doprnt.o app/blink/printf.o $(INCLUDES)  -nostartfiles -nostdlib -T app/app_base.ld  -o app/blink/blink.elf 
